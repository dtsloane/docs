...
Our goal with insights is to narrow in on the potential root causes when it comes to changes in your health. Even with one device connected, we can 'get more juice' from the data. 
